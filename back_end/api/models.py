...
class Constat(models.Model):
    ...
    numr_tlfn_autre_assure = models.IntegerField(blank=True, null=True)
...
class Accident(models.Model):
    ...
    date_accident = models.CharField(max_length=255)

class Degat(models.Model):
    accident = models.OneToOneField(Accident, on_delete=models.CASCADE, related_name='degat')
    photo = models.ImageField(upload_to='media/degat_photos/', blank=True, null=True)
...
class Voiture(models.Model):
    ...
    carte_grise = models.CharField(primary_key=True)
